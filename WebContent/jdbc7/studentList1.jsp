...
<body>
	<div class="container">
		...
		<table class="table table-bordered table-condensed">
			...
			<tbody>
				...
				%>
				<tr
					data-url="studentEdit1.jsp?id=<%=student.getId()%>&pg=<%=currentPage%>&ss=<%=ss%>&st=<%=stEncoded%>&od=<%=od%>">
					<td><%=student.getId()%></td>
	...
	<script> $("[data-url]").click(function() { var url = $(this).attr("data-url"); location.href = url; }) </script>
</body>
</html>